...
using System.Text;
using SQLiteORMV1.ExpressionTree;

namespace SQLiteORMV1
{
    ...
    internal class WhereNull : Where
    {
        ...
        public WhereNull(string field, bool isNotNull)
            : base(field)
        {
    ...
    internal class WhereStringOp : Where
    {
        ...
        internal WhereStringOp(string field, object val, string operation)
            : base(field)
        {
            _val = val;
