    ...
    public partial class MyVScrollBar : UserControl
    {
        ...
        public Control BindControl
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    if (value.GetType() == typeof(PanelMultiplex))
                    {
        ...
        {
            PanelMultiplex pnl = sender as PanelMultiplex;
        ...
        public void UpdateScrollbar()
        {
            if (this.moControl == null)
                return;
            if (this.moControl.GetType() == typeof(PanelMultiplex))
            {
                PanelMultiplex control = this.moControl as PanelMultiplex;
        ...
        private void MoveThumbGetValue()
        {
            ...
            if (this.moControl != null)
            {
                ...
                else if (this.moControl.GetType() == typeof(PanelMultiplex))
                {
                    PanelMultiplex pnl = this.moControl as PanelMultiplex;
