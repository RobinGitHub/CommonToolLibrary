...
namespace CommonControls
{
    ...
    public class CustomComboBox : ComboBox, IPopupControlHost
    {
        ...
        /// </summary>
        [Category("Custom Drop-Down"), Description("Indicates if drop-down is resizable."), DefaultValue(false)]
        ...
        /// </summary>
        [Category("Custom Drop-Down"), Description("Indicates current sizing mode."), DefaultValue(SizeMode.UseControlSize)]
        ...
        /// 是否只读
        /// </summary>
        [Category("Custom Drop-Down"), DefaultValue(true)]
        ...
        /// Indicates current sizing mode.
        /// </summary>
        SizeMode m_sizeMode = SizeMode.UseControlSize;
        /// <summary>
