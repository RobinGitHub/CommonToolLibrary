...
namespace CommonControls
{
    ...
    {
        #region 属性
        private bool isOnlyText = true;
        [Browsable(true)]
        [DefaultValue(typeof(bool), "true"), Description("是否只能输入文字")]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [NotifyParentProperty(true)]
        public bool IsOnlyText
        {
            get { return isOnlyText; }
            set
            {
                isOnlyText = value;
            }
        ...
        /// 边框颜色   
        /// </summary>   
        private Color _BorderColor = Color.FromArgb(217, 217, 217);

        /// <summary>   
        /// 热点边框颜色   
        /// </summary>   
        private Color _HotColor = Color.FromArgb(217, 217, 217);
       ...
       DefaultValue(typeof(Color), "#335EA8")]
        ...
        {
            if (!isOnlyText) return base.ProcessCmdKey(ref msg, keyData);
            switch (keyData)
            {
                #region Control + V
