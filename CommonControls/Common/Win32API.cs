...
namespace Common
{
    ...
    public class Win32API
    {
        ...
        /// <summary>
        /// 闪烁窗口
        /// http://www.2cto.com/kf/201409/333457.html
        /// </summary>
        /// <param name="hWnd">窗口句柄</param>
        /// <param name="type">闪烁类型</param>
        /// <returns></returns>
        public static bool FlashWindowEx(IntPtr hWnd, falshType type)
        {
        ...
        #region 设置控件enable=false时的背景色
        /// <summary>
        /// 设置控件enable=false时的背景色
        /// </summary>
        /// <param name="c"></param>
        ...
        {
            if (enabled)
            { SetWindowLong(c.Handle, (int)SetWindowLongOffsets.GWL_STYLE, (~(int)WindowStyles.WS_DISABLED) & GetWindowLong(c.Handle, (int)SetWindowLongOffsets.GWL_STYLE)); }
            else
            { SetWindowLong(c.Handle, (int)SetWindowLongOffsets.GWL_STYLE, (int)WindowStyles.WS_DISABLED + GetWindowLong(c.Handle, (int)SetWindowLongOffsets.GWL_STYLE)); }
        }
        #endregion
